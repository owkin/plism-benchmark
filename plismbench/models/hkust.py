...
def _download_state_dict() -> str:
    """Download GPFM state dict from official Github repository."""
    url = "https://github.com/birkhoffkiki/GPFM/releases/download/ckpt/GPFM.pth"
    output_path = os.path.join(os.environ["HOME"], "GPFM.pth")
...
class GPFM(Extractor):
    ...
    def __init__(
        ...
        _state_dict_path = _download_state_dict()
